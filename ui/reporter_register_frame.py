...
class ReporterRegisterFrame(ctk.CTkFrame):
    """Reporter-only registration frame."""
    ...
    def __init__(self, parent, app):
        ...
        inputs_inner.place(relx=0.5, rely=0.5, anchor="center")
        ...
        try:
            ...
            user_icon_img = email_icon_img = password_icon_img = None
        ...
        back_to_login_btn = ctk.CTkButton(
            ...
            width=100, height=36,
            corner_radius=6,
            command=lambda: app.show_frame("ReporterLoginFrame")
        )
    ...
    def register(self):
        ...
        # Create reporter user (default role)
        ok = self.app.db.create_user(u, e, p, role="reporter")
        if not ok:
            messagebox.showerror("Error", "Username already taken.")
            return

        messagebox.showinfo("Success", "Account created. Please log in.")
        self.app.show_frame("ReporterLoginFrame")
